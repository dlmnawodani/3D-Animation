...
public class Table implements GLEventListener {
	...
	public Table(int furniRed, int furniGreen, int furniBlue, int seatRed, int seatGreen,
			int seatBlue) {
	...
	public void drawTableInRoom(GL2 gl) {
	    Cube cube = new Cube();
